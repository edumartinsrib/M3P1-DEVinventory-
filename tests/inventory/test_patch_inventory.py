...
def test_patch_inventory_success_status_204(client, logged_in_client):
    ...
    payload = delete_keys_by_atribute(
...
def test_patch_inventory_fail_with_invalid_fields(client, logged_in_client):
    """Test of the user route with a valid token"""
    payload_patch = delete_keys_by_atribute(
        payload_just_values_and_keys, 'patch', True
    )
...
def test_patch_inventory_fail_with_invalid_payload_values(
    client, logged_in_client
):
    """Test of the user route with a valid token"""
    payload_patch = delete_keys_by_atribute(
        payload_just_values_and_keys, 'type', int
    )
    payload_just_field_value = delete_keys_by_atribute(
        payload_patch, 'type', str
    )
...
def test_patch_inventory_fail_with_invalid_payload_value_null(
    client, logged_in_client
):
    """Test of the user route with a valid token"""
    payload_patch = delete_keys_by_atribute(
...
def test_patch_inventory_fail_with_invalid_payload_value_negative(
    client, logged_in_client
):
    """Test of the user route with a valid token"""
    payload_patch = delete_keys_by_atribute(
